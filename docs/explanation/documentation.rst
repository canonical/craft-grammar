.. meta::
  :description: An explanation of the documentation system, process, and writing style and conventions in Craft Grammar.
...
The documentation is an essential part of Craft Grammar. We make documentation a
...
Craft Grammar practices docs-as-code. The document source files are written in
reStructuredText markup and kept inside the Craft Grammar source code. Like the rest of
...
The Craft Grammar maintainers try and review every PR in a timely manner, typically
