...
Craft Grammar has a community from all over the world, and the Craft Grammar team welcomes all
contributions.

Contributing offers an opportunity to polish your technical skills, develop as a
professional, and get involved in the growing open source community. Craft Grammar
...
The Starcraft team at Canonical sets the direction and priorities of Craft Grammar. They
take responsibility for its stewardship and health.

Before you start work on Craft Grammar, there are three documents for you to digest.
...
Craft Grammar is licensed under [LGPL-3.0](LICENSE).

## Report an issue or open a request

If you find a bug or feature gap in Craft Grammar, look for it in the [project's GitHub
issues](https://github.com/canonical/craft-grammar/issues) first. If you have fresh input,
add your voice to the issue.

If the bug or feature doesn't have an issue, we invite you to [open
one](https://github.com/canonical/craft-grammar/issues/new/choose).

## Set up for development

Craft Grammar uses a forking, feature-based workflow. Most work on Craft Grammar occurs on
...
Start by [creating a personal fork](https://github.com/canonical/craft-grammar/fork) of the
...
```bash
git clone git@github.com:<username>/craft-grammar --recurse-submodules
cd craft-grammar
git remote add upstream git@github.com:canonical/craft-grammar
git fetch upstream
```
...
```bash
git clone https://github.com/<username>/craft-grammar --recurse-submodules
cd craft-grammar
git remote add upstream https://github.com/canonical/craft-grammar
git fetch upstream
```
...
All significant work in Craft Grammar should be tied to an existing issue or ticket.

Once you find an issue that you'd like to work on, it's best to reach out so that a
Craft Grammar maintainer can assign the ticket to you before starting. This process varies
...
Craft Grammar maintainer will assign it to you.

If you don't find a related issue, [open
one](https://github.com/canonical/craft-grammar/issues/new/choose) and indicate that you're
interested in taking it on. When creating the issue, be sure to add any relevant labels.
A Craft Grammar maintainer will then review the issue and assign it to you.
...
[Diátaxis](https://diataxis.fr) category for the page. A Craft Grammar maintainer will
...
Craft Grammar's test suite includes unit and integration tests. If you're not
...
the four categories of [Diátaxis](https://diataxis.fr), the framework that Craft Grammar's
...
Ensure that feature changes and fixes are also documented in the [changelog](docs/changelog.rst).
...
On GitHub, [open a PR](https://github.com/canonical/craft-grammar/compare) for your branch in
Craft Grammar.
...
The Craft Grammar maintainers try to review every PR in a timely manner, typically within a
